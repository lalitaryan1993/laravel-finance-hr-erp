...
export default function CreatePurchaseOrder({ vendors = [] }) {
        ...
        <AppLayout>
            ...
            <div className="space-y-6 max-w-5xl">
                ...
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="icon" onClick={() => router.visit('/vendors/purchase-orders')}>
                        <ArrowLeft className="w-4 h-4" />
                    </Button>
                    <div>
                        <h1 className="text-2xl font-bold">New Purchase Order</h1>
                        <p className="text-muted-foreground text-sm mt-1">Create a new order for a vendor</p>
                    </div>
                </div>
                        ...
                        <CardContent className="pt-4 grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <textarea value={data.terms_conditions}
                                    ...
                                    rows={3} placeholder="Payment terms, delivery terms…"
                                    className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-ring" />
                            </div>
                        </CardContent>
                    </Card>
